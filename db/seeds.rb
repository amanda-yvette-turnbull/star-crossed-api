...
User.create(auth0_id: '6', name: 'joan', age: 18 , email: 'sampleemail@gmail.com', gender: 'femme', preference: '["femme"]', bio: 'this is my bio', birthday: '', image: 'images/users/joan.jpg', star_sign_id: '4', matches: '[]', compatibility: '[2,1,2,5,4,3,1,5,4,1,3,2]')
User.create(auth0_id: '7', name: 'samuel', age: 18 , email: 'sampleemail@gmail.com', gender: 'masc', preference: '["femme", "them"]', bio: 'this is my bio', birthday: '', image: 'images/users/samuel.jpg', star_sign_id: '5', matches: '[]', compatibility: '[5,4,3,2,1,3,2,1,5,4,1,2]')
User.create(auth0_id: '8', name: 'crispin', age: 18 , email: 'sampleemail@gmail.com', gender: 'them', preference: '["masc", "them"]', bio: 'this is my bio', birthday: '', image: 'images/users/crispin.jpg', star_sign_id: '7', matches: '[]', compatibility: '[3,4,5,3,2,4,1,5,1,2,3,1]')
User.create(auth0_id: '9', name: 'gino', age: 18 , email: 'sampleemail@gmail.com', gender: 'masc', preference: '["masc", "them"]', bio: 'this is my bio', birthday: '', image: 'images/users/gino.jpg', star_sign_id: '8', matches: '[]', compatibility: '[1,2,3,5,4,3,5,1,4,1,2,1]')
User.create(auth0_id: '10', name: 'clara', age: 18 , email: 'sampleemail@gmail.com', gender: 'femme', preference: '["masc", "them"]', bio: 'this is my bio', birthday: '', image: 'images/users/clara.jpg', star_sign_id: '9', matches: '[]', compatibility: '[1,2,3,5,4,3,5,1,4,1,2,1]')
User.create(auth0_id: '11', name: 'dante', age: 18 , email: 'sampleemail@gmail.com', gender: 'masc', preference: '["femme"]', bio: 'this is my bio', birthday: '', image: 'images/users/dante.jpg', star_sign_id: '10', matches: '[]', compatibility: '[5,4,2,1,3,1,4,2,5,1,3,1]')
User.create(auth0_id: '12', name: 'juliette', age: 18 , email: 'sampleemail@gmail.com', gender: 'femme', preference: '["masc"]', bio: 'this is my bio', birthday: '', image: 'images/users/juliette.jpg', star_sign_id: '12', matches: '[]', compatibility: '[4,3,2,1,3,5,2,1,4,3,5,1]')
